...
\begin{figure}
  ...
  \caption{The distribution of approximate census population sizes estimated by this
   ...
   are available in \cite{Damuth1987-sg}.}{\includegraphics[]{figures/damuth.pdf}}\label{figsupp:damuth}
...
\figdata{The complete diversity and population size dataset for 172 metazoan taxa.}
